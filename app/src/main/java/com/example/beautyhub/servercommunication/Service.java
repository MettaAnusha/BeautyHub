                ...
                JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                        ...
                        new Response.Listener<JSONArray>() {
                                ...
                                public void onResponse(JSONArray response) {
                                        Log.d("service", "Response received: " + response.toString());
                                        ...
                                        try {
                                                for (int i = 0; i < response.length(); i++) {
                                                        ...
                                                        Log.d("ServiceData", "ServiceId: " + service.getServiceId());
                                                        Log.d("ServiceData", "ServiceName: " + service.getServiceName());
                                                        Log.d("ServiceData", "ServiceDescription: " + service.getDescription());
                                                        Log.d("ServiceData", "ServiceImage: " + service.getServiceImage());
                                                }
